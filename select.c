...
// Note (John Fredrik): This whole thing could be stored as a uint64 with
// bitfiddling instead, and if I want more than 64 units per controlgroup I
// could just use two of them(?)
